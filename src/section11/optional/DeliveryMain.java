...
import section11.optional.model.Delivery;
import section11.optional.model.Order;

import java.util.HashMap;
import java.util.Map;
import java.util.Optional;

// Delivery 가 없거나, 배송이 취소된 경우 배송 X
public class DeliveryMain {
    ...
    static {
        ...
        orderRepository.put(3L, new Order(3L, new Delivery("배송중", false)));
